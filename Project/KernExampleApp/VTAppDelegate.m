...
static NSString *TestSQLiteFileName = @"TestStore";
static NSString *InvalidStoreFileName = @"InvalidStoreFileName";

@implementation VTAppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Setup Kern
    [Kern setupCoreDataStackWithSqliteFileName:InvalidStoreFileName];
